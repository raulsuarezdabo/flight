# ************************************************************
# FLIGHT Atrium Master
# @author: Raul Suarez <raul@suarez.com.es>
#
# MySQL Database Model Export
# Base de datos: flight
# ************************************************************


# Volcado de tabla Airline
# ------------------------------------------------------------
...
CREATE TABLE `Airline` (
  ...
  `CountryCode` varchar(3) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `CodeAirline` (`Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;



# Volcado de tabla Airplane
# ------------------------------------------------------------
...
CREATE TABLE `Airplane` (
  ...
  `Maker` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `Year` int(4) DEFAULT NULL,
  `Num_seats_total` int(11) DEFAULT NULL,
  `Num_seats_tourist` int(11) DEFAULT NULL,
  `Num_seats_business` int(11) DEFAULT NULL,
  `Num_seats_offer` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;



# Volcado de tabla Airport
# ------------------------------------------------------------
...
CREATE TABLE `Airport` (
  ...
  `CountryCode` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `Book` (
  ...
  `FlightID` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `book_foreing_key_user` (`UserID`),
  KEY `boo_foreing_key_flight` (`FlightID`),
  CONSTRAINT `boo_foreing_key_flight` FOREIGN KEY (`FlightID`) REFERENCES `Flight` (`ID`),
  CONSTRAINT `book_foreing_key_user` FOREIGN KEY (`UserID`) REFERENCES `User` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
# Volcado de tabla CountryLanguage
# ------------------------------------------------------------
...
CREATE TABLE `Flight` (
  ...
  `AirportFrom` int(11) unsigned DEFAULT NULL,
  `AirportTo` int(11) unsigned DEFAULT NULL,
  `Start` datetime DEFAULT NULL,
  `Time` time DEFAULT NULL,
  `Airplane` int(11) unsigned DEFAULT NULL,
  `CreatedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `AirportFrom` (`AirportFrom`),
  KEY `AirportTo` (`AirportTo`),
  KEY `AirplaneModel` (`Airplane`),
  CONSTRAINT `flight_ibfk_1` FOREIGN KEY (`AirportFrom`) REFERENCES `Airport` (`ID`),
  CONSTRAINT `flight_ibfk_2` FOREIGN KEY (`AirportTo`) REFERENCES `Airport` (`ID`),
  CONSTRAINT `flight_ibfk_3` FOREIGN KEY (`Airplane`) REFERENCES `Airplane` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
VALUES
	(2,X'41444D494E5F524F4C45'),
	(1,X'555345525F524F4C45');
...
CREATE TABLE `Seat` (
  ...
  `Fullname` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `CreatedAt` datetime DEFAULT NULL,
  `BookID` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `foreing_seat_id` (`FlightID`),
  KEY `foreaing_book_id` (`BookID`),
  CONSTRAINT `foreaing_book_id` FOREIGN KEY (`BookID`) REFERENCES `Book` (`ID`),
  CONSTRAINT `foreing_seat_id` FOREIGN KEY (`FlightID`) REFERENCES `Flight` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `User` (
  ...
  KEY `ForeingKeyCity_idx` (`CityId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;



# Volcado de tabla UserRole
# ------------------------------------------------------------
...
CREATE TABLE `UserRole` (
  ...
  PRIMARY KEY (`ID`),
  KEY `role_foreing_key_idx` (`RoleID`),
  KEY `user_foreing_key` (`UserID`),
  CONSTRAINT `role_foreing_key` FOREIGN KEY (`RoleID`) REFERENCES `Role` (`ID`),
  CONSTRAINT `user_foreing_key` FOREIGN KEY (`UserID`) REFERENCES `User` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
