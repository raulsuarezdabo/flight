...
public class EditAirplaneBean {
    ...
    public void init() {
        ...
        AirplaneEntity airplane = this.airplaneService.getById(this.id);
     ...
     */
    public String editAirplaneAction() {
        try {
            AirplaneEntity airplaneEdit = new AirplaneEntity();
            airplaneEdit.setMaker(this.maker);
            airplaneEdit.setModel(this.model);
            airplaneEdit.setYear(this.year);
            airplaneEdit.setNumSeatsTotal(this.numSeatsTotal);
            airplaneEdit.setNumSeatsOffer(this.numSeatsOffer);
            airplaneEdit.setNumSeatsTourist(this.numSeatsTourist);
            airplaneEdit.setNumSeatsBusiness(this.numSeatsBusiness);
            AirplaneEntity airplane = this.airplaneService.updateAirplane(id, airplaneEdit, true);
            if (airplane != null) {
                //Success update
                FacesContext.getCurrentInstance().getExternalContext().getFlash().put(Message.SUCCESS, 
                    FacesContext.getCurrentInstance().getApplication().getResourceBundle(
                        FacesContext.getCurrentInstance(), "msg").getString("editSuccessAirplaneMessage")
                );
            }
            else {
                //Error creating
                FacesContext.getCurrentInstance().getExternalContext().getFlash().put(Message.DANGER, 
                    FacesContext.getCurrentInstance().getApplication().getResourceBundle(
                        FacesContext.getCurrentInstance(), "msg").getString("editDangerAirplaneMessage")
                );
            }
        } catch (Exception e) {
